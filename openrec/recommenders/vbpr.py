...
def VBPR(batch_size, dim_user_embed, dim_item_embed, dim_v, total_users, total_items, l2_reg_embed=None,
    ...
    @t.inputgraph(outs=['p_item_vfeature', 'n_item_vfeature'], overwrite=False)
    ...
    @s.inputgraph(outs=['item_vfeature'], overwrite=False)
    ...
    @t.itemgraph(ins=['p_item_vfeature', 'n_item_vfeature'], overwrite=False)
    ...
    @s.itemgraph(ins=['item_vfeature'], overwrite=False)

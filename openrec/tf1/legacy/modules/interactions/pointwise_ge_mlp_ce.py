...
from openrec.tf1.legacy.modules.interactions import PointwiseGeCE
from openrec.tf1.legacy.modules.interactions import PointwiseMLPCE
...
class PointwiseGeMLPCE(Interaction):
    ...
    dims: Numpy array.
        Specify the size of the MLP (openrec.tf1.legacy.modules.extractions.MultiLayerFC).
